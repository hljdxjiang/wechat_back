import {
  ...
  UserOutlined,
  WechatFilled,
  DashboardOutlined,SettingFilled
...
import SysTokenConfig from '@/pages/sys/sysTokenConfig'
...
import BackSysMenus from '@/pages/back/backSysMenus'
...
import WechatMenusVersion from '@/pages/wechat/wechatMenusVersion'
...
import BackRuleDetail from '@/pages/back/backRuleDetail'
import BackSysRevokes from '@/pages/back/backSysRevokes'
/**
 * path 跳转的路径
 * component 对应路径显示的组件
...
const preDefinedRoutes: MenuRoute[] = [
  ...
  // },
  {
    ...
    routes: [
      ...
      {
        path: '/sys/tokenconfig',
        name: 'token信息表',
        exact: true,
        key: 'sys:tokenconfig',
        component: SysTokenConfig
      },
      {
        path: '/sys/blacklist',
        name: '黑名单表',
      ...
      {
        path: '/back/ruledetail',
        name: '角色权限详情表',
        exact: true,
        key: 'back:ruledetail',
        component: BackRuleDetail
      },
      {
        path: '/back/sysrevokes',
        name: '系统权限表',
        exact: true,
        key: 'back:sysrevokes',
        component: BackSysRevokes
      },
    ]
  }
  , {
